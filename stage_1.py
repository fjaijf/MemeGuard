    ...
    messages = [
        {
            ...
            "content": [
                ...
                {"type": "text", "text": "Please describe this picture in detail and extract the meaning behind the text description, including background information, character information, homophonic information, and any other relevant context:"},
            ],
        }
    ]
...
train_json_path = "/mnt/pfs-guan-ssai/nlu/guhexiang/Qwen-CoT/caption_train.json"
